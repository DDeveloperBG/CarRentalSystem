namespace WebAPI.Common
{
    public static class ValidationConstants
    {
        public static class User
        {
            ...
            public const int MinForenameLength = 2;
            public const int MaxForenameLength = 40;

            public const int MinSurnameLength = 2;
            public const int MaxSurnameLength = 40;

            public const string PhoneNumberRegex = @"\d+";
        ...
        public static class CarRentingRequest
        {
            public const int MinRentingPeriodInDays = 1;
        }
    }
}
